# Generated by Powerlevel10k configuration wizard on 2020-06-13 at 12:14 DST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    cas_ext_package_path    # env variable CAS_EXTERNAL_PACKAGE_PATH
  )
  ...
  function my_git_formatter() {
    ...
    # totok 13-jun-2020 want always show tracking branch
    # Show tracking branch name if it differs from local branch.
    # if [[ -n ${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH} ]]; then
    #   res+="${meta}:${clean}${(V)VCS_STATUS_REMOTE_BRANCH//\%/%%}"  # escape %
    # fi
    res+="${meta}:${clean}${VCS_STATUS_REMOTE_NAME//\%/%%}/${(V)VCS_STATUS_REMOTE_BRANCH//\%/%%}"  # escape %

    # totok 13-jun-2020 disable these segments
  ...
  # totok 13-jun-2020 remove the next line
  ...
  function prompt_cas_ext_package_path() {
    p10k segment -f yellow -t "$(echo ${CAS_EXTERNAL_PACKAGE_PATH})"
  }
